...
\new{One important implementation trade-off is whether evaluation of a composition 
of signal functions is {\em push-based} or {\em pull-based}.
The {\em signal vector} technique provides a type-level
  description of the inputs and outputs of signal functions, while
...
We describe a novel signal-function FRP system which provides push-based evaluation
